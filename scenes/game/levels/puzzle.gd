...
func _init(_applicant_name, _appl_image, _validate_solution, _work_type, _difficulty, _level_day, _time_limit, _requisites_answers, _cross_questions, _salary_offer, _special_condition, 
