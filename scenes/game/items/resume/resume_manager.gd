...
func _calculate_amount_by_applicant():
	var current_applicant_result:ApplicantResult = applicant_result_list[current_applicant_index]
	current_salary_amount += current_applicant_result.current_salary_applicant
